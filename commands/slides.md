...
- `help` → read and print `${CLAUDE_PLUGIN_ROOT}/skills/slides/references/notation-reference.md`
...
1. Read the `slides` skill definition for parsing rules
...
8. Render: `node ${CLAUDE_PLUGIN_ROOT}/skills/slides/references/slide-renderer.js <json> <output.pptx>`
